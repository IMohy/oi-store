    ...
    <div className="filters">
      ...
      <div className="filters-field">
        ...
        >
          ...
          <option value="name-asc">الاسم من الأصغر إلى الأكبر</option>
          <option value="name-desc">الاسم من الأكبر إلى الأصغر</option>
      ...
      <div className="filters-field">
        ...
        {(products.length === 0 && isLoading) || max === 0 ? (
          <h5 className="text-subtle">جاري تحميل التصنيفات</h5>
        ) : products.length === 1 ? (
          <h5 className="text-subtle">لا يوجد تصنيفات</h5>
        ) : (
          <PriceRange
            min={min}
            max={max}
