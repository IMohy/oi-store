...
const FormSchema = Yup.object().shape({
  fullname: Yup.string()
    .min(4, 'الاسم يجب ان يكون اكثر من 4 احرف.')
    .max(60, 'الاسم يجب ان يكون اقل من 60 حرف.')
...
const EditProfile = () => {
  useDocumentTitle('Edit Account | OI-Store');
  useScrollTop();
  ...
  return (
    <Boundary>
      <div className="edit-user">
        <h3 className="text-center">تعديل البيانات الشخصية</h3>
        <Formik
